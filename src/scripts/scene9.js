...
export default function init(canvas) {
  ...
  const ringPointTexture = textureLoader.load('particles/2.png')
  ...
  function tick() {
    ...
    ringGroup.rotation.x = Math.sin(elapsedTime * 0.15) * 0.1
    ringGroup.rotation.y = Math.cos(elapsedTime * 0.1) * 0.1
    ringGroup.rotation.z = Math.cos(elapsedTime * 0.15) * 0.1
